...
const faqs = ref([
  ...
  },
  {
    ...
    answer: 'Ми підтримуємо близько 15 провідних ритейлерів України.',
    open: false
  },
  {
  ...
  },
  {
    ...
    answer: 'Підписка "Скаут" (Premium) дозволяє відстежувати до 15 товарів одночасно з частотою перевірки кожні 6 годин та надає пріоритет у черзі сповіщень.',
    open: false
  },
  {
